...
(() => {
var exports = {};
exports.id = "pages/api/ks/delete";
exports.ids = ["pages/api/ks/delete"];
exports.modules = {
...
/***/ "./pages/api/ks/delete.js":
/*!********************************!*\
  !*** ./pages/api/ks/delete.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! child_process */ \"child_process\");\n/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(child_process__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var helpers_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! helpers/api */ \"./helpers/api/index.js\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,helpers_api__WEBPACK_IMPORTED_MODULE_1__.apiHandler)({\n  post: podDelete\n}));\n\nfunction podDelete(req, res) {\n  // split out password from user details\n  console.log(req.body);\n  const message = req.body;\n  const words = message.split(' ');\n  console.log(\"delete \" + words[1] + \" in \" + words[0]);\n  const command = \"kubectl create -f ./yaml_template/\" + words[1] + \".yaml\";\n  const kubectl_delete = (0,child_process__WEBPACK_IMPORTED_MODULE_0__.exec)(command);\n  kubectl_delete.stdout.on('data', data => {\n    console.log(`stdout: ${data}`);\n  });\n  kubectl_delete.stderr.on('data', data => {\n    console.error(`stderr: ${data}`);\n  });\n  kubectl_delete.on('close', code => {\n    console.log(`child process exited with code ${code}`);\n  });\n  return res.status(200).json({});\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./pages/api/ks/delete.js\n");
...
var __webpack_exports__ = (__webpack_exec__("./pages/api/ks/delete.js"));
